...
if data.raw.recipe["y-mf2d-recipe"] then
	table.insert(data.raw.technology["yi-organic-oil-atomics"].effects, {type = "unlock-recipe", recipe = "y-mf2d-recipe"})
end
...
table.insert(tiers, 
	{
		...
		},
		{
			...
			effects =
			{
			  ...
			  {
				type = "unlock-recipe",
				recipe = "ye_rheins_LT_recipe"
			  },
			  {
				type = "unlock-recipe",
				recipe = "ye_rheins_MT_recipe"
			  },
			  {
				type = "unlock-recipe",
				recipe = "ye_rheins_HT_recipe"
			  },			  
			},
			unit =
			{
...
table.insert(tiers, 
	{
		...
		},
		{
			...
			effects =
			{
				...
				{
					type = "unlock-recipe",
					recipe = "ye_mfheatmotor_m_recipe"
				},
				{
					type = "unlock-recipe",
					recipe = "ye_mf_mfheatmotor_m_recipe"
				},
				{
					type = "unlock-recipe",
					recipe = "y-ffe-recipe"
				...
				{
					type = "unlock-recipe",
					recipe = "ye_tfmw_turbine-s-recipe"
				},
				{
					type = "unlock-recipe",
